...
namespace TouchTracking.iOS
{
    public class TouchEffect : PlatformEffect
    {
        ...
        protected override void OnAttached()
        {
            ...
            RotatingTable.Xamarin.TouchTracking.TouchEffect effect =
                (RotatingTable.Xamarin.TouchTracking.TouchEffect)Element.Effects.FirstOrDefault(
                    e => e is RotatingTable.Xamarin.TouchTracking.TouchEffect);
